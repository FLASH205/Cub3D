...
/*   Updated: 2025/08/13 17:11:53 by ybahmaz          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float	get_correct_distance(t_data *data, t_player *player, int i)
{
...
void	v2_raycast(t_data *data, t_player *player, float angle)
{
	...
	while (i < WIDTH)
	{
		...
		correct_dist = get_correct_distance(data, data->player, i);
